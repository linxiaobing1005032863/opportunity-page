$(window).ready(function () {
	$('.profile-left li').click(function(){
		...
		$('.profile-right div').removeClass('profile-act2').eq($(this).index()).addClass('profile-act2');
	...
	$('.profile-right input').click(function(){
		...
		$('.profile-right div').removeClass('profile-act2').eq($(this).index()-3).addClass('profile-act2');
